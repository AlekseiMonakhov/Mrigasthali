...
const GuruMaharajPage: FC = () => {
  ...
  useEffect(() => {
    const images = Array.from({ length: 25 }, (_, i) => `/assets/Naraharinath/${i + 1}.jpg`);
    ...
    const textContent = (
      <div className={styles.textContainer}>
        ...
        <div className={styles.imageContainer}>
          <Image src={images[0]} alt="Guru Maharaj 1" width={300} height={200} className={styles.image} />
        </div>
        <p className={styles.text}>
        ...
        <div className={styles.imageContainer}>
          <Image src={images[1]} alt="Guru Maharaj 2" width={300} height={200} className={styles.image} />
        </div>
        <p className={styles.text}>
        ...
        <div className={styles.imageContainer}>
          <Image src={images[2]} alt="Guru Maharaj 3" width={300} height={200} className={styles.image} />
        </div>
        <p className={styles.text}>
        ...
        <div className={styles.imageContainer}>
          <Image src={images[3]} alt="Guru Maharaj 4" width={300} height={200} className={styles.image} />
        </div>
        <p className={styles.text}>
        ...
        <div className={styles.imageContainer}>
          <Image src={images[5]} alt="Guru Maharaj 6" width={300} height={200} className={styles.image} />
        </div>
        <p className={styles.text}>
        ...
        <div className={styles.imageContainer}>
          <Image src={images[6]} alt="Guru Maharaj 7" width={300} height={200} className={styles.image} />
        </div>
        <p className={styles.text}>
        ...
        <div className={styles.imageContainer}>
          <Image src={images[7]} alt="Guru Maharaj 8" width={300} height={200} className={styles.image} />
        </div>
        <p className={styles.text}>
        ...
        <div className={styles.imageContainer}>
          <Image src={images[8]} alt="Guru Maharaj 9" width={300} height={200} className={styles.image} />
        </div>
        <p className={styles.text}>
        ...
        <div className={styles.imageContainer}>
          <Image src={images[9]} alt="Guru Maharaj 10" width={300} height={200} className={styles.image} />
        </div>
        <p className={styles.text}>
        ...
        <div className={styles.imageContainer}>
          <Image src={images[10]} alt="Guru Maharaj 11" width={300} height={200} className={styles.image} />
        </div>
        <p className={styles.text}>
        ...
        <div className={styles.imageContainer}>
          <Image src={images[11]} alt="Guru Maharaj 12" width={300} height={200} className={styles.image} />
        </div>
        <p className={styles.text}>
          Yogi's Patriotism:
        </p>
        ...
        <div className={styles.imageContainer}>
          <Image src={images[12]} alt="Guru Maharaj 13" width={300} height={200} className={styles.image} />
        </div>
        <p className={styles.text}>
        ...
        <div className={styles.imageContainer}>
          <Image src={images[13]} alt="Guru Maharaj 14" width={300} height={200} className={styles.image} />
        </div>
        <p className={styles.text}>
        ...
        <div className={styles.imageContainer}>
          <Image src={images[14]} alt="Guru Maharaj 15" width={300} height={200} className={styles.image} />
        </div>
        <p className={styles.text}>
          Yogi Narharinath passed away at the age of 88 years on Tuesday 13th Falgun 2059 at 12:40 PM at Mrigasthali Ashram.
        </p>
        <div className={styles.imageContainer}>
          <Image src={images[22]} alt="Guru Maharaj 23" width={300} height={200} className={styles.image} />
        </div>
        ...
        <div className={styles.imageContainer}>
          <Image src={images[16]} alt="Guru Maharaj 17" width={300} height={200} className={styles.image} />
        </div>
        <p className={styles.text}>
        ...
        <div className={styles.imageContainer}>
          <Image src={images[17]} alt="Guru Maharaj 18" width={300} height={200} className={styles.image} />
        </div>
        <p className={styles.text}>
          Yogi in Vedic work:
        </p>
        ...
        <div className={styles.imageContainer}>
          <Image src={images[18]} alt="Guru Maharaj 19" width={300} height={200} className={styles.image} />
        </div>
        <p className={styles.text}>
        ...
        <div className={styles.imageContainer}>
          <Image src={images[19]} alt="Guru Maharaj 20" width={300} height={200} className={styles.image} />
        </div>
        <p className={styles.text}>
        ...
        <div className={styles.imageContainer}>
          <Image src={images[20]} alt="Guru Maharaj 21" width={300} height={200} className={styles.image} />
        </div>
        <p className={styles.text}>
        ...
        <div className={styles.imageContainer}>
          <Image src={images[21]} alt="Guru Maharaj 22" width={300} height={200} className={styles.image} />
        </div>
        <p className={styles.text}>
        ...
        <div className={styles.imageContainer}>
          <Image src={images[23]} alt="Guru Maharaj 24" width={300} height={200} className={styles.image} />
        </div>
        <p className={styles.text}>
        ...
        <div className={styles.imageContainer}>
          <Image src={images[4]} alt="Guru Maharaj 5" width={300} height={200} className={styles.image} />
        </div>
        <p className={styles.text}>
        ...
        <div className={styles.imageContainer}>
          <Image src={images[15]} alt="Guru Maharaj 16" width={300} height={200} className={styles.image} />
        </div>
        <p className={styles.text}>
        ...
        <div className={styles.imageContainer}>
          <Image src={images[24]} alt="Guru Maharaj 25" width={300} height={200} className={styles.image} />
        </div>
        <p className={styles.text}>
  ...
  return (
    <>
      ...
      <div className={styles.container}>
        <Title mainTitle='Sri Rastra Guru Yogi Naraharinath Maharaj' />
        {content}
      </div>
      <Footer />
    </>
